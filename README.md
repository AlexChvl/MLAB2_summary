...
w1d4: Part 2: Hyperparameter search: We train a resnet model on the cifar10 task. We do some hyperparameter tuning and use Weights and Biases to track the progress.