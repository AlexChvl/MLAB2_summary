...
Note that we cache the images locally - this is the polite thing to do to avoid repeatedly using the remote server's bandwidth, and allows you to work offline after the data is downloaded.
